...
import { ChevronDown, Lock, BellRing, Pin, MoreHorizontal, Share2, UserX, TicketXIcon, UserMinus, MessageSquareCode, MessageSquareWarning, SearchIcon, Share2Icon } from "lucide-react"
        ...
        <CardContent className="p-0">
          <div className="space-y-4 mx-8">
            <div className="h-[350px] w-full">
              <img
                src={groupProfile.coverImage || "https://www.facebook.com/images/groups/groups-default-cover-photo-2x.png"}
                alt="Cover"
