...
=======
      ...
      case "Private":
        return <EarthIcon className="size-4" />;
>>>>>>> 942987e93344fbc8659800e130e477d3c177a48e
      case "OnlyMe":
        return <EarthIcon className="size-4" />;
      case "Include":
        return <EarthIcon className="size-4" />;
  ...
  const renderPeopleList = (type: string) => {
    switch (type) {
      case "reaction":
        return <ul>{/* for each reactions => li */}</ul>;
      case "comment":
        return <ul>{/* for each comment => li */}</ul>;
      case "reactionComment":
        return <ul>{/* for each comment => li */}</ul>;
      case "share":
        return <ul>{/* for each share => li */}</ul>;
      default:
        return null;
    }
  };
        ...
        <CardFooter className="flex-col items-start">
          <div className="flex w-full justify-between">
            ...
            <div className="space-x-2">
              ...
              <HoverCard>
                ...
                <HoverCardContent>{renderPeopleList("share")}</HoverCardContent>
              </HoverCard>
            </div>
          </div>
          ...
          <div className="w-full flex gap-x-1">
            ...
            <div className="flex-1 relative">
              <Input
                type="text"
                placeholder="Comment as Nguyen Minh Tuan"
                className="rounded-full"
              />
              <div className="absolute top-0 right-0 flex items-center justify-end gap-x-1 h-full mx-2">
                <HoverCard>
                  <HoverCardTrigger asChild>
                    <Button
                      variant={"ghost"}
                      className="size-6 rounded-full my-auto"
                    >
                      <Sticker />
                    </Button>
                  </HoverCardTrigger>
